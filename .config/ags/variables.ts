...
export const date_less = Variable("").poll(1000, () => GLib.DateTime.new_now_local().format("%b %e  %H:%M")!);
export const date_more = Variable("").poll(1000, () => GLib.DateTime.new_now_local().format(", %A.")!);
